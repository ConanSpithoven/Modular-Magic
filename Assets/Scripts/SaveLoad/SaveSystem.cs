...
public static class SaveSystem
{
    ...
    #region Game
    public static void SaveGameData(int score, int time, int lives)
    {
        BinaryFormatter formatter = new BinaryFormatter();
        string path = Application.persistentDataPath + "/gamedata.mgc";
        FileStream stream = new FileStream(path, FileMode.Create);

        GameData data = new GameData(score, time, lives);
